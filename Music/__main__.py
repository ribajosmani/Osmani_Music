...
async def load_start():
    ...
    if restart_data:
        print("[INFO]: SENDING RESTART STATUS TO OSMANI BOT")
        try:
    ...
    await client.send_message(LOG_GROUP_ID, "Assistant Of Osmani Music Started")
    print("[INFO]: STARTED THE OSMANI BOT AND SENDING THE INFO TO OSMANI BOT")
